...
\begin{document}
    ...
    The Contaminationresitances of Categories A, B and C are 0, +1 and +2 respectively.\\

    Contamination: \\
    Contamination is a term used to describe the amalgamation of technology destroying nanoweapons, radiation, pollution and general
    environmental hazard. Contamination is airborne, waterborne, bloodborne and permeates pretty much everything in the
    environment. It is usually assigned a level describing its intensity. Only within the Domes of the Supervivo, inside a
    Mech or in a similarily purified environment the Contaminationlevel is 0. Levels 1-4 are rare areas of low Contamination, like Mines,
    Airlocks, outdoor markets, outdoor settlements and so on. Levels 5-8 are the most common and usually uninhabited. Levels
    9 and higher are found in Oceans, Deserts, and somewhat secluded areas. There is no upper limit for Contaminationlevels. \\\\*
    If an entity is in an area with Contamination, every hour Contaminationresistance is checked. If the Check fails, the entity takes
    one point of Contamination damage (causing a wound if applicable). If the check fails with a difference of 10 or more,
    additional damage might be taken.\\

    Contaminationdamage: Anytime the a character receives Contamination damage, the character increases in Charactercontamination.
    Charactercontamination is applied as an internal bonus on the Contaminationresistance Check. \\

    Contaminationcheck:  Contaminationresistance with no bonuses from external sources or CharacteQrcontamination, but +2 for CatB and +4 for CatC
    ist tested against Charactercontamination. If it fails, one point of Contamination damage is inflicted. If it fails with a
    difference of 10 or more, additional damage is inflicted. On a draw no damage is applied, but no healing of wounds takes
    place.\\
    Every day a Contaminationcheck occurs for every character with Charactercontamination(unless the roll is irrelevant).
    Every started hour a character directly interacts with an entity, the Charactercontamination of that character is
    applied as Contamination damage, resisted by a Contaminationresistance Check.\\\\*
    ...
    Approximate survival durations(with 0 Charactercontamination and without increases in Charactercontamination, CatB and CatC can savely
    have Charactercontamination that shifts those tables):\\\\
    \begin{tabular}{c|c|c}
        Category A & Category B & Category C\\
        \begin{tabular}{c|l}
            Contamination level&Duration\\
            0&indefinite\\
            1&contaminating\\
            2&7 and a half days\\
            3&2 and a half days\\
    ...
    the Contamination level or better; \\X HP divided by 24 hours in a day times lost health in a day minus 1 (normal healing))\\\\
    \normalsize
    ...
    A blueprint states the name of the Item, its category, its bonus on a Contaminationresistance check and the required materials.\\\\
    ...
    \begin{tabular}{c|cccll}
        Type & Level & Size &Sizeclass & Damagetype & Costs & Range &Check & Special\\
        \hline BaseTech&&&&&\\
        Metal Sword & 2 & M & 1*S & Physical &  30 m & 2m*S & Piloting & Ignores any shield non-physical modulated Shield \\
        Manned Turret & X & 1 & < 2 & X & manual labor +X &  X & X depends on mounted weapon, is fired by pilot or crew\\
        \hline Lowtech &&&&&\\
        Heavy Machinegun & 3 & 1 & 2 & Physical Rapid & 0.5H 0.005A & 50/100/200/500/1000 & Projectile.Direct&\\
        Light Artillery & 3 & 4 & 15 & Physical Area & 5 E 10H 0.2A & 1k/3k/5k/7k/10k & Projectile.Indirect & 300m/s, minimum range 100m\\
        \hline Midtech &&&&&\\
        Autocannon & 2/4 & 3 & 5 & Physical/ Physical Rapid & 0 E 2 H 0.01A / 1E 5H 0.15A & per 400m & Projectile.Direct & for Burst mode Mech has to stand\\
        Basic Pulse Laser & 1 & 2 & 5 & Energy Spike & 5E 8 H & per 1k & Energy.Pulse &  damage falls off by 1 every 200 m\\
        Precision Cannon & 2 &3& 8 & Physical Spike & 5E 10H 0.1A & per 1k & Projectile.Direct & Allows Sniping\\
        Rocket Launcher & 4 & 2 & 5 & Physical Spike & 5H 0.12A &per 300m & Rocket.Dumbfire & Ignores Shields\\
        \hline Hightech &&&&&\\
        Rocket Platform & 3 & 3 & 7 & Physical Spike & 5H 0.2A & - & Rocket.Guided & Ignores Shields, Will hit if Lock is sustained\\
        Railgun & 2 &5& 10 & Physical Spike & 15E 5H 0.01 A& 100/1k/3k/8K/20k & Projectile.Direct & requires Indirect for targets further away than 2k, allows sniping\\
        Advanced Pulse Laser & 1 &3 & 7  &Energy Spike/ Rapid & 7E 8H &per 2k & Energy.Pulse & damage falls off by 1 every 1k \\
        Beam Laser & X & M & 3 & Energy Rapid & XE 2XH & per 1k & Energy.Beam & X goes up when shooting, goes down when not shooting, X is capped at M, allows sniping \\
    \end{tabular}
    Misc Modules\newline
