...
\begin{document}
    ...
    \begin{tabular}{|r|r|l}
        ...
        \hline
        drinking Water & 1 & Drinkable (2kg/day), Liquid, Decontaminated, Raw, Bland \\\hline
        Grain & 1 & Agricultural, Contaminated, Raw \\\hline
        CleanGrain & 2 & Agricultural, Decontaminated, Raw \\\hline
        Meals & 3 & Edible (2.5kg/day), Decontaminated, Appetizing\\\hline
        Rations & 10 & Edible (0.4kg/day), ContaProof, Plain\\\hline
        Softdrinks & 3 & Drinkable (2kg/day), Liquid, Decontaminated, Plain \\\hline
        Beer & 6 & Drinkable (slightly alcoholic), Liquid, Decontaminated, Appetizing \\\hline
        Wine & 8 & Drinkable (medium alcoholic), Liquid, Decontaminated, Tasty \\\hline
        Luxury Drinks & 15 & Drinkable(varying), Liquid, Decontaminated, Delicious \\\hline
        \hline
        Alacast & 10,000 & Decontamination, Mineral, Experimental\\\hline
        Fuel Rods & 1,000 & Fuel(Radioactive), Highly Processed, Dense \\\hline
        Liquid Hydrogen & 30 & bulky (x8), Fuel(PEM), Highly Processed, Flammable \\\hline
        LiquidCombustionFuel & 3 & Fuel(Combustion), Processed, Flammable\\\hline
        Coal & 1 & Contaminating(5), Fuel(Solid), Flammable, Processed\\\hline
        \hline
        Highest End Chemicals & 100 & Industry, Liquid, Luxury\\\hline
        High End Chemicals & 50 & Industry, Liquid, Hightech \\\hline
        Industrial Chemicals & 20 & Industry, Liquid, Midtech \\\hline
        Low End Chemicals & 10 & Industry, Liquid, Lowtech \\\hline
        Basic Chemicals & 5 & Industry, Liquid, Basetech \\\hline
        Chemical Components & 2 & Industry Liquid, Raw \\\hline
...
(rework on its way)
    ...
    You get 300 Credits, you can spend these on:\\
    Your Mech (see below)\\
    Goods (1Credit:500) (see table in chapter Trade)\\
    XP (1 XP for 15 credits)\\
    ...
    threshholds: percentage of movement system on mech for movement speeds. Cargo holds count as 20\% lighter per
    free space\newline
    ...
    \begin{tabular}{c|c|l}
        ...
        Manned gun, Ramshield, Floatation,   Metal Armorplating , Extra Cargo (5), steam engine, passive cooling}\\&&\\
    ...
    \begin{tabular}{c|cccccl}
        ...
        \hline Hightech\\
        Advanced Shield & 4 & 1/2(3H) & \makecell{15H, block,\\disable}& 16+C\(\cdot\)10 & 8-R + 10E & 5r \\
    \end{tabular}\newline\newline\newline
    ...
    \begin{tabular}{c|cccll}
        ...
        \hline BaseTech&&&&&\\
        Extended Cargo & 1 & \makecell{\(\sqrt{M}\)\\ rounded down}& 14\(\cdot\)M & destroy 1 & \makecell[{{p{6cm}}}]{3 Cargo Spaces (Cargo is destroyed with the modules)}\\
        ...
        \hline Hightech &&&&&\\
        Advanced Light & 2 & 3 & 33+M*6 & \makecell[l]{Disables Systems \\ Decided on before} &\makecell[l]{Repairable with Lowtech Materials}\\
        Charged & 5 & X & 10+15\(\cdot\)M & \makecell[l]{shorts out \\ 1 Energy System}&\makecell[{{p{6cm}}}]{
        1h Check[Electronics] \\(>=8 to fix; <=2 to destroy)}\\
    \end{tabular}\\\newline\newline
    \subsection{Weapons}
    ...
    \begin{tabular}{c|cccclll}
        ...
        \hline Lowtech &&&&&\\
        Heavy Machinegun & 4 & 1 & 3 & P R & 0.5H 0.002A & 50/100/200/500/1000 & Projectile.Direct\\
        ...
        \hline Midtech &&&&&\\
        Autocannon & \makecell[c]{~2/\\4} & 3 & 7 & \makecell[c]{P/\\P R} &\makecell[l]{0E 2H 0.01A /\\1E 5H 0.1A }& per 400m & Projectile.Direct\\
    ...
    Requires Reprocessing Rating of 1\\
    \newline
    Cargo compartment\\
    Cargo Space: 5 \\
    \newline
    ...
    Requires Reprocessing Rating of 2\\
    \newline
    Basic Air Filter\\
    ...
    Required Reprocessing 2\\
    \newline
    Optical Sensors\\
    Energy: 1\\
    Size: 0.25 \\
    Rating: 100\\
    Provides Targetting Lock \\
    Visual Lock: Hitting Bonus of square root (Target Visual Signature -(Distance/Rating)) \\
    \newline
    Thermal Sensors\\
    Energy: 1\\
    Size 0.25\\
    Rating 20\\
    Thermal Lock: Hitting Bonus of square root (Target Thermal Signature -(Distance/Rating))Distance/Rating <= Target Thermal Signature\\
    \newline
    ...
    Energy: 0.5\\
    Module: Processor\\
    Programming also requires Black Biotech 3\\
    \newline
    ...
    If used on Humans, Roll Red Biotech, remove one Charactercontamination on 6 or less, consumes additional 10g Alacast or fails.\\
    Always Inflicts Wound of Level 11-RollResult\\
    Requires Reprocessing 3\\
    \newline
    ...
    Alacast Usage per Operation if Decontaminating: 1g/t of raw material, 10g/human\\
    Detoxes and Decontaminates up to 5t of material, including air and water.\\
    Living Entities suffer no harm, and on a 4 or more on a Red Biotech Roll lose one Contamination level.
    Furthermore all Infections and Appropriate Toxins are removed.\\
    Requires Reprocessing 4\\
    \newline
    Advanced AutoMedic\\
    ...
    Software may supply the Red Biotech roll even autonomously.\\
    To Ressurect:\\
    requires 1g of EOL per total spent point on a character (or 20* the average level of an NPC)
    ...
    \newline
    Direct Neural Interface Controls\\
    Energy Cost: 10E per Activation\\
    size: 0.5\\
    When Activating the DNI, the user takes over their mech as an extension of their body, having
    extremely fine control over it. It comes at a price though.\\
    At Activation Resonance is Rolled. The Result is stored and can be spend on raising the result of
    any rolls made by the mech that could be improved by better control over it. For every time any number of
    points are allocated that way, 1 Neural Strain is generated.\\
    Can be reactivated any time as a free action, the stored result is overwritten, not added onto. Reactivation causes
    1 Neural Strain.\\
    Deactivation Causes 1 Neural Strain. Then the accumulated Neural Strain is applied to the character as damage
    affecting the neural system (causing headaches, jitters and so on, every 3 points lowering Mind, Perception and
    Dexterity Results by 1) reduced by a Resonance roll. Neural strain persists, and is reduced by 1 every day.
    Staying inside the Direct Neural Interface Controls, applies the current Neural strain every hour.\\
    \newline
